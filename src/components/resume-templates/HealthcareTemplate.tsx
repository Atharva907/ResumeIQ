export default function HealthcareTemplate({ data }: { data: any }) {
  return (
              ...
              <div className="p-4 bg-white rounded-lg shadow-md">
                <div className="flex flex-wrap gap-2">
                  {data.skills.map((skill: any, i: number) => (
                    <span key={i} className="px-3 py-1 bg-linear-to-r from-teal-100 to-blue-100 rounded-full text-sm text-teal-700">{skill}</span>
                  ))}
                </div>
              </div>
            </section>
