      ...
      <header className="bg-gradient-to-r from-blue-600 to-blue-800 text-white p-6 rounded-t-lg">
        <div className="flex justify-between items-start">
          <div>
            ...
            <h2 className="text-xl opacity-90">{data.title || "Software Engineer"}</h2>
          </div>
          ...
          <div className="flex-1">
            {data.summary && (
              <section className="mb-6">
                <h2 className="text-xl font-bold mb-3 pb-2 border-b-2 border-blue-600 text-blue-600">Summary</h2>
                  ...
                  <div key={i} className="mb-5 border-l-2 border-blue-600 pl-5 relative">
                    ...
                    <div className="mb-2">
                      <div className="flex justify-between mb-1">
                        ...
                        <span className="text-sm text-gray-500 bg-blue-100 px-2 py-1 rounded">{exp.duration}</span>
                      </div>
                  ...
                  <div key={i} className="mb-3 border-l-2 border-blue-600 pl-5 relative">
                    ...
                    <div className="mb-1">
                      <div className="flex justify-between mb-1">
                        ...
                        <span className="text-sm text-gray-500 bg-blue-100 px-2 py-1 rounded">{edu.duration}</span>
                      </div>
