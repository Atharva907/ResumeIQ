      ...
      <header className="mb-8 pb-6 border-b-2 border-teal-600">
        <div className="flex justify-between items-start">
          <div>
            ...
            <h2 className="text-xl text-teal-700 mb-4">{data.title || "Healthcare Technology Professional"}</h2>
          ...
          <div className="text-right">
            <div className="text-3xl font-bold text-teal-600">
              {data.healthcareTechMetrics?.systems || "15+"}
            </div>
            <div className="text-sm text-teal-600">Systems Implemented</div>
            <div className="text-2xl font-bold text-teal-600 mt-2">
              {data.healthcareTechMetrics?.efficiency || "45%"}
            </div>
            <div className="text-sm text-teal-600">Efficiency Improvement</div>
          </div>
        </div>
      </header>

      {/* Healthcare Tech Summary */}
      {data.summary && (
