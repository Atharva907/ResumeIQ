      ...
      <header className="mb-8 pb-6 border-b-2 border-blue-600">
        <div className="flex justify-between items-start">
          <div>
            ...
            <h2 className="text-xl text-blue-700 mb-4">{data.title || "Engineering Professional"}</h2>
          ...
          <div className="text-right">
            <div className="text-3xl font-bold text-blue-600">
              {data.engineeringMetrics?.projects || "25+"}
            </div>
            <div className="text-sm text-blue-600">Projects Completed</div>
            <div className="text-2xl font-bold text-blue-600 mt-2">
              {data.engineeringMetrics?.patents || "5"}
            </div>
            <div className="text-sm text-blue-600">Patents Filed</div>
          </div>
        </div>
      </header>
