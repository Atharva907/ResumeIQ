      ...
      <header className="bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200 p-6 rounded-t-lg">
        <div className="flex justify-between items-start">
          <div>
            ...
            <h2 className="text-xl text-gray-600">{data.title || "Software Engineer"}</h2>
          </div>
          ...
          <div className="flex-1">
            {data.summary && (
              <section className="mb-6">
                <h2 className="text-xl font-bold mb-3 pb-2 border-b-2 border-gray-700 text-gray-700">Summary</h2>
