...
export default function ElegantSerifTemplateImproved({ data }: { data: any }) {
  return (
    <div className="min-h-[29.7cm] w-[21cm] mx-auto bg-white shadow-lg" id="resume-preview">
      {/* Elegant header with serif font */}
      <header className="bg-linear-to-r from-amber-50 to-amber-100 border-b-2 border-amber-200 p-6 rounded-t-lg">
