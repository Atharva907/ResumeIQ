export default function CulinaryTemplate({ data }) {
  return (
              ...
              <div className="p-4 bg-white rounded-lg shadow-md">
                <div className="flex flex-wrap gap-2">
                  {data.skills.map((skill, i) => (
                    <span key={i} className="px-3 py-1 bg-gradient-to-r from-orange-100 to-red-100 rounded-full text-sm text-orange-700">{skill}</span>
                  ))}
                </div>
              </div>
            </section>
