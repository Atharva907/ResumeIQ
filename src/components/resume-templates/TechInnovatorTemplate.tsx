    ...
    <div className="p-8 bg-gradient-to-br from-gray-900 to-blue-900 text-white" id="resume-preview">
      ...
      <header className="mb-8 pb-6 border-b border-gray-700">
        <div className="flex items-center gap-6 mb-4">
          <div className="w-24 h-24 bg-gradient-to-br from-blue-400 to-purple-600 rounded-lg"></div>
          <div>
            <h1 className="text-4xl font-bold mb-2">{data.name || "John Doe"}</h1>
            <h2 className="text-xl text-blue-300">{data.title || "Tech Professional"}</h2>
          </div>
        </div>
