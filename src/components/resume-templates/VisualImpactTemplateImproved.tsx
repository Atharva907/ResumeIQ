                  ...
                  <div key={i} className="mb-5 border-l-2 border-red-600 pl-5 relative">
                    ...
                    <div className="mb-2">
                      <div className="flex justify-between mb-1">
                        ...
                        <span className="text-sm text-gray-500 bg-red-100 px-2 py-1 rounded">{exp.duration}</span>
                      </div>
                  ...
                  <div key={i} className="mb-3 border-l-2 border-red-600 pl-5 relative">
                    ...
                    <div className="mb-1">
                      <div className="flex justify-between mb-1">
                        ...
                        <span className="text-sm text-gray-500 bg-red-100 px-2 py-1 rounded">{edu.duration}</span>
                      </div>
