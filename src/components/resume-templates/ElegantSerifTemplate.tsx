...
export default function ElegantSerifTemplate({ data }: { data: any }) {
  return (
    <div className="p-8 font-serif text-gray-800 bg-white shadow-lg" id="resume-preview" style={{ fontFamily: 'Georgia, serif' }}>
      ...
      <header className="mb-8 relative">
        <div className="absolute top-0 left-0 right-0 h-1 bg-linear-to-r from-transparent via-gray-400 to-transparent"></div>
        ...
        <div className="absolute bottom-0 left-0 right-0 h-1 bg-linear-to-r from-transparent via-gray-400 to-transparent"></div>
      </header>
